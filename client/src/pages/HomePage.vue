  ...
  <div id="homePage" :class="userTheme">
      ...
      <section class="_content">
        ...
        <div class="_content__container _container even">
          ...
          <div class="_content__text">
            Мы даём возможность студентам находить друзей по общежитию, просить помощи в любой момент, а так же обменять любые вещи. Этот сайт, в первую очредь, создан для улучшения и упрощения жизни обычных учащихся, давая простор в общении и заведении новых знакомств. Вы должны помнить, наш сайт - ваш лучший друг при жизни общежитии.	
          </div>
        </div>
